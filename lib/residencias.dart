...
class ResidenciasScreen extends StatefulWidget {
  @override
  _ResidenciasScreenState createState() => _ResidenciasScreenState();
}

class _ResidenciasScreenState extends State<ResidenciasScreen> {
...
class PostTile extends StatelessWidget {
  ...
  Future<void> _deletePost(String postId) async {
    try {
      ...
      await FirebaseFirestore.instance.collection('posts_practicas').doc(postId).delete();
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              child: Text(
                "Eliminar",
                style: TextStyle(color: Color(0xFFFF0609)),
              ),
              onPressed: () {
                _deletePost(postId); 
                Navigator.of(context).pop();
