...
import 'residencias_alumno.dart';
import 'main.dart';
...
class _HomeScreenState2 extends State<HomeScreen2> {
  ...
  Widget build(BuildContext context) {
    ...
    width: 26.0 * 1.1,
    height: 26.0 * 1.1,
    color: Color(0xFF006ef9), // Color del ícono, puedes adaptarlo al tema si es necesario
        ),
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(
              child: SvgPicture.asset(
                ...
                height: 200.0, // Ajusta el tamaño según sea necesario
                color: Color(0xFF006EF9), // Color azul especificado
              ),
            );
          }
...
class _PostTileState extends State<PostTile> {
  ...
  void initState() {
    ...
    _checkIfFavorite(); // Verificar si ya está en favoritos
  }

  // Verifica si la publicación ya está guardada como favorita
